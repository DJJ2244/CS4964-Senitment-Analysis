...
This link contains the Yelp business review data. Click the first "Download JSON" button. Once the zip file is downloaded, unzip it. Inside of the resutling folder there is a yelp_dataset.tar, expand this file. We will then use the file titled, "yelp_academic_dataset_review.json".
